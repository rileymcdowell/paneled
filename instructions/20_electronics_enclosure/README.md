...
<img src="empty_box.jpg" alt="empty box" width="500"/>
...
* Use a 0.6mm diameter nozzle at 0.2mm layer height. With these settings, each box takes about 18 hours to complete.
* Print with an 8mm brim to keep the sharp corners from lifting.
* Use a generous coat of purple glue stick to ensure good adhesion.
* Use a wall line count of 4. This keeps the screw holes surrounded by several lines of solid plastic to thread into.
...
<img src="lid.jpg" alt="lid.jpg" width="500"/>
...
<img src="box_with_power_supply.jpg" alt="box with power supply" width="500"/>
...
<img src="box_with_ps_and_wires.jpg" alt="box with power supply and wires" width="500"/>

### Step 3
Next we need to adjust a buck converter to buck down to 5V from a higher voltage. 
...
<img src="adjusting_buck_converter.jpg" alt="adjusing buck converter" width="500"/>
...
<img src="box_with_buck_converter.jpg" alt="box with buck converter" width="500"/>
...
<img src="buck_converter_with_wires.jpg" alt="buck converter with wires" width="500"/>
...
<img src="box_with_pcb_mounted.jpg" alt="box with pcb mounted" width="500"/>
...
<img src="pcb_with_12V_wires.jpg" alt="pcb with 12V wires" width="500"/>
...
<img src="pcb_with_led_plug.jpg" alt="pcb with led plug" width="500"/>

### Step 9

Fire up your soldering iron again, it's time to solder the IEC-320 C14 fused socket.
The correct wiring is shown. These wires need not be much larger capacity than
...
so don't hesitate to crank your temperature up (say 275C) and hold it 
...
<img src="with_power_plug.jpg" alt="with power plug" width="500"/>