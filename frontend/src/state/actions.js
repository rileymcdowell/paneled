...
export const doUpdateProposedPanel = "panel/updateProposal";
export const doApplyProposedGroup = "group/applyProposal";
export const doApplyProposedPanel = "panel/applyProposal";